      ...
      <div className='flex mt-[150px]'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <p className='text-[24px]'>
            ...
            tenetur iusto tempora vero debitis cumque reiciendis ipsam Eos error
            iste nobis fugiat eveniet fugit maxime officiis quisquam
            consequuntur quo
          </p>
          <p className='text-[24px]'>Lorem ipsum dolor sit amet consectetur</p>
          <div>
